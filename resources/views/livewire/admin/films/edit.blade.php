<div class="h-full overflow-y-auto scrollbar-hide">
    ...
    <div class="w-full px-4 md:px-10 pb-60">
        ...
        @if (session()->has('message'))
            <div class="bg-green-500/10 border border-green-500/20 text-green-500 p-8 rounded-[28px] text-xs uppercase font-black tracking-widest mb-16 animate-fadeInSlow shadow-[0_20px_40px_rgba(0,0,0,0.4)] flex items-center gap-4">
                <span class="material-symbols-outlined text-2xl">verified</span>
                <div>
                    <p class="leading-none mb-1">DATA BERHASIL DIPERBARUI</p>
                    <p class="text-[9px] opacity-60 font-medium tracking-normal">{{ session('message') }}</p>
                </div>
            </div>
        @endif

        <!-- Main Form Grid -->
        <form wire:submit.prevent="update" class="flex flex-col xl:flex-row gap-10 items-start">
            ...
            <div class="w-full xl:w-[400px] space-y-10 shrink-0">
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-center text-[8px] text-gray-700 font-bold uppercase tracking-[4px] leading-relaxed">Pastikan seluruh h-data sudah sesuai regulasi sebelum memperbarui record.</p>
                </div>
