<div class="min-h-screen relative flex items-center justify-center p-4 bg-black overflow-x-hidden">
    ...
    <div class="relative z-10 w-full max-w-[420px] bg-neutral-900 shadow-[0_0_80px_rgba(0,0,0,0.8)] border border-white/5 rounded-2xl p-10 animate-cardSlide">
        <div class="text-center mb-10">
            <h1 class="logo text-4xl text-[#E50914] mb-3 tracking-[3px] font-black animate-fadeIn delay-1">CINEWATCH</h1>
            <h2 class="text-white text-xl font-bold uppercase tracking-tight animate-fadeIn delay-2">Kembali Menonton</h2>
            <p class="text-[10px] text-gray-500 mt-2 font-bold uppercase tracking-[2px] animate-fadeIn delay-3 opacity-60">Gunakan Akun Member Premium</p>
        </div>
        ...
        <form wire:submit.prevent="login" class="space-y-6">
            <div class="animate-fadeIn delay-4">
                <label class="block text-gray-400 text-[10px] font-black uppercase tracking-[2px] mb-2.5 ml-1">Email / Username</label>
                <input wire:model="email" type="email" placeholder="nama@email.com" 
                       class="w-full h-12 bg-neutral-800 border border-white/10 rounded-lg px-4 text-white focus:ring-1 focus:ring-[#E50914] focus:bg-neutral-700 outline-none transition-all placeholder:text-gray-600 text-sm" />
            ...
            <div class="animate-fadeIn delay-5">
                <label class="block text-gray-400 text-[10px] font-black uppercase tracking-[2px] mb-2.5 ml-1">Password</label>
            ...
            <div class="flex items-center justify-between text-[10px] font-black uppercase tracking-[2px] animate-fadeIn delay-6">
                <label class="flex items-center gap-2 cursor-pointer group text-gray-500 hover:text-white transition-colors">
                    <input type="checkbox" class="w-4 h-4 rounded border-white/10 bg-neutral-800 text-[#E50914] focus:ring-0 cursor-pointer" />
            ...
            <button type="submit" wire:loading.attr="disabled" 
                    class="w-full bg-[#E50914] hover:bg-[#B20710] py-4 rounded-lg text-white font-black text-xs uppercase tracking-[4px] transition-all transform hover:scale-[1.01] active:scale-[0.99] shadow-xl animate-fadeIn delay-7">
        ...
        <div class="mt-8 pt-8 border-t border-white/5 text-center animate-fadeIn delay-8">
            <p class="text-gray-600 text-[10px] font-black uppercase tracking-widest leading-relaxed">Belum Bergabung?<br>
